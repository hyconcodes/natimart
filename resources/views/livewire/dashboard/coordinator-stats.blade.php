...
new class extends Component {
    public function with()
    {
        ...
        return [
            ...
            'recentActivity' => Shop::where('state', $state)
                ->latest()
                ->take(3)
                ->get(),
        ];
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white dark:bg-brand-900 rounded-3xl border border-brand-200 dark:border-brand-800 overflow-hidden h-[400px]">
                ...
                <div class="relative h-full flex items-center justify-center">
                     ...
                     <span class="relative text-gray-400 font-medium">Regional analytics visualization</span>
                </div>
            </div>
        </div>
                    ...
                    @forelse($recentActivity as $shop)
                        <div class="flex items-center gap-4">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="text-xs text-gray-400">{{ $shop->is_approved ? 'Recently approved' : 'Needs your approval' }}</div>
                            </div>
