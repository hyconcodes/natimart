                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        ...
                        @foreach ($states as $state)
                            <a href="{{ route('state.products', ['state' => \Illuminate\Support\Str::slug($state)]) }}" class="group flex items-center p-4 bg-white border border-gray-100 rounded-xl hover:border-hub-green hover:shadow-md transition-all">
                                <div class="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center mr-3 group-hover:bg-hub-green/10 transition-colors">
                                    <svg class="w-4 h-4 text-hub-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
